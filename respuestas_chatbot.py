        ...
        if Intento['tag'] == Etiqueta:
            ...
            if Intento['tag'] == "fecha":
                ...
                return [
                    ...
                    TelefonoPrincipal + '<b> </b><a href="tel:6677126606,7023"><button class="archivo"><b>Consulta Externa Recepción: </b>7023</button></a>'
                ]
            elif Intento['tag'] == "credencial_imss_bienestar":
                return [
                    Respuesta,
                    f'<b>Requisitos para Tramita la Credencial</b>'
                    f'<div style="display: flex; gap: 20px;">'
                        f'<section class="card">'
                            f'<header>'
                                '<p>'
                    ...
                    '<b>Teléfono Principal y Extensiones</b>'
                    '\n<a href="tel:6677126606"><button class="info">6677126606 📞</button></a>'
                    '<b> </b><a href="tel:6677126606,7104"><button class="archivo"><b>INSABI:</b> 7104</button></a>'
                ]
